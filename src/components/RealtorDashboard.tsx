      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Manage your properties and connect with renters</p>
            </div>
          </div>
          ...
          <Card className="p-6 bg-white/70 backdrop-blur-md">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{unreadMatches.length}</p>
              </div>
        ...
        <Card className="bg-white/70 backdrop-blur-md">
          <div className="p-6 border-b">
            ...
            <p className="text-gray-600 text-sm">Renters interested in your properties</p>
          </div>
          ...
          <div className="p-6">
            {matches.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">Upload your first property to start getting matches!</p>
              </div>
            ) : (
                ...
                {matches.map((match) => (
                  <div key={match.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="flex items-center space-x-4">
                      ...
                      />
                      <div>
                        <h3 className="font-medium">{match.apartment.title}</h3>
                        ...
                        <div className="flex items-center space-x-2 mt-2">
                          ...
                          <Badge className="bg-gradient-to-r from-orange-100 to-pink-100 text-orange-800">
